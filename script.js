...
class GameObject{
    ...
    moveTowardsTarget(target) {
        ...
        if (distance>target.characterRadius){   //If object is not already inside player char
...
function update() {
    ...
    player.drawPlayer();
    player.playerMoveInput();   //Updates Player Character movement
